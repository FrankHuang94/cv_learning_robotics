...
For **Embodiment Scaling Questions**, the paper-level specification should name the random variables,
...
1. Which latent variables are necessary and sufficient for embodiment scaling questions, and
