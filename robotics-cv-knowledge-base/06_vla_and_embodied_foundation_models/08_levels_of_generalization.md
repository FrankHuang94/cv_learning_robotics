...
> **Level:** Advanced
> **Why It Matters for Robotics:** Embodied foundation models place visual representation learning inside a perception-memory-reasoning-action loop, where errors alter the next observation and can cause physical failure. Levels Of Generalization must be evaluated by its effect on physical decisions, not only by passive recognition accuracy.
> **Related Sections:** [Language Conditioned Control](09_language_conditioned_control.md), [Generalist Vs Specialist](07_generalist_vs_specialist.md), [Knowledge Base Index](../INDEX.md)
...
For **Levels Of Generalization**, the paper-level specification should name the random variables,
...
1. Which latent variables are necessary and sufficient for levels of generalization, and
